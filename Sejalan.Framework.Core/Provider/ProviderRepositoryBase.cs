...
{
	public abstract class ProviderRepositoryBase : ProviderBase
	{
		public ProviderRepositoryBase()
		{
		}
		
		public abstract ProviderRepositoryInfo GetProviderRepositoryInfo(string providerFactoryKey);
