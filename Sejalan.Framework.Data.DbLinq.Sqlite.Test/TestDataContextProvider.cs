...
{
	public class TestDataContextProvider : DataContextProviderBase
	{
		...
		{
			return new TestDataContext(new SqliteConnection(connectionString));
		}
		
		#endregion
		public TestDataContextProvider ()
		{
		}
	}
}
